  ...
  return (
    <main>
      ...
      <section className="relative">
        <div className="relative h-[560px] w-full md:h-[650px]">
        ...
        <div className="absolute inset-0">
          <div className="mx-auto flex h-full max-w-6xl items-center px-6">
            <div className="max-w-2xl text-white">
              <p className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-sm">
              ...
              <p className="mt-5 text-lg text-white/85">
                Admin support, transaction coordination, marketing assistance, and ISA follow-up —
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-gray-600">
                Choose one service or combine multiple to create a complete support system.
              </p>
            </div>
          ...
          <div className="mt-10 grid gap-4 rounded-2xl border bg-gray-50 p-6 md:grid-cols-3">
            <MiniHighlight title="Fast onboarding" desc="Start in days, not weeks — with simple systems." />
            <MiniHighlight title="Real estate focused" desc="Workflows built for listings, buyers, and transactions." />
            <MiniHighlight title="Flexible plans" desc="Part-time, full-time, or project-based support." />
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-3 text-gray-600">
                We’ll match you with the right support level, organize your workflow, and keep tasks moving
                so you can focus on revenue work.
              </p>

              <div className="mt-6 flex flex-wrap gap-3">
                <Link
                  href="/how-it-works"
                  className="rounded-xl border bg-white px-5 py-3 text-sm font-semibold text-gray-900 hover:bg-gray-100"
                >
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div className="rounded-2xl border bg-gradient-to-b from-white to-gray-50 p-6 shadow-sm">
              <p className="text-sm font-semibold text-gray-900">What you get</p>
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                <Stat title="Reliable delivery" desc="Clear expectations & consistent follow-through." />
                <Stat title="Real estate trained" desc="Workflows built for agents and teams." />
                <Stat title="Lower overhead" desc="Scale support without in-house costs." />
                <Stat title="More time back" desc="Focus on clients, not admin tasks." />
              </div>
              ...
              <div className="mt-6 rounded-xl bg-white p-4 text-sm text-gray-700">
                ...
                We turn your best practices into simple SOPs so tasks get done the same way every time.
              </div>
            </div>
            ...
            <div>
              ...
              <p className="mt-3 text-gray-600">
                You’ll get dependable support, a repeatable task system, and a team that helps you stay organized
                and consistent — even when business gets busy.
              </p>
      ...
      <section className="border-t bg-gray-50">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <div className="rounded-2xl px-8 py-10 text-white shadow-sm"
               style={{ background: `linear-gradient(135deg, ${BRAND.teal}, ${BRAND.blue})` }}>
            <h2 className="text-3xl font-semibold tracking-tight">
              Ready to delegate and grow?
            </h2>
            <p className="mt-2 max-w-2xl text-white/85">
              Book a consultation and we’ll recommend the best plan for your workflow and goals.
            </p>
            <div className="mt-6">
              <Link
                href="/book-a-consultation"
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 inline-flex items-center gap-2 text-sm font-semibold">
        <span className="underline underline-offset-4 group-hover:opacity-80" style={{ color: BRAND.blue }}>
          Learn more
        </span>
