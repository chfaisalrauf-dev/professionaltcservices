  ...
  return (
    <footer className="border-t bg-gray-50">
      <div className="mx-auto max-w-6xl px-6 py-14">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <Link
              ...
              className="mt-5 inline-flex rounded-xl px-4 py-2 text-sm font-semibold text-white hover:opacity-95"
              style={{
          ...
          <div>
            ...
            <div className="mt-4 space-y-2 text-sm text-gray-600">
              <p>Email: faisal@professionaltcservices.com</p>
        ...
        {/* BOTTOM BAR */}
        <div className="mt-12 border-t pt-6 text-sm text-gray-500 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <p>© {new Date().getFullYear()} Professional TC Services. All rights reserved.</p>
