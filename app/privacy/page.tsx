export default function PrivacyPolicyPage() {
  return (
    <main className="bg-white">
      ...
      <section>
        <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-14 lg:py-16">
          <div className="space-y-8 text-sm leading-7 text-gray-700 sm:space-y-10 sm:text-base">
            {/* Legal disclaimer */}
            <div className="rounded-2xl border bg-white p-5 shadow-sm sm:p-6">
              ...
              <div className="mt-4 space-y-4">
                <p>
                  The information provided on this website, including all
                  content related to Transaction Coordination services, is for
                  general informational purposes only and does not constitute
                  legal, financial, or professional advice.
                  ProfessionalTCServices makes no guarantees regarding the
                  accuracy, completeness, or reliability of any information on
                  this site.
                </p>

                <p>
                  By using this website, you understand and agree that
                  ProfessionalTCServices is not a law firm, does not provide
                  legal representation, and is not responsible for any actions
                  taken based on the information found on this site. You should
                  consult an attorney, broker, or qualified professional for
                  advice related to your specific situation or real estate
                  transaction.
                </p>
            ...
            <div className="rounded-2xl border bg-white p-5 shadow-sm sm:p-6">
              ...
              <div className="mt-4 space-y-4">
                <p>
                  ...
                  explains how we collect, use, and safeguard data when you
                  visit our website or use our Transaction Coordination services
                  in the United States.
                </p>

                <p>
                  No mobile opt-in text message consent will be shared with
                  third party or affiliates.
                </p>
              </div>
            </div>
            ...
            <PolicySection title="3. Sharing of Information">
              ...
              <ul className="mt-3 list-disc pl-6">
                <li>
                  Real estate parties involved in your transaction (agents,
            ...
            <PolicySection title="4. Data Protection">
              <p>
                We take reasonable measures to store and protect your data
                securely.
              </p>
              <p className="mt-3">
            ...
            <PolicySection title="7. Changes to This Policy">
              ...
              <p className="mt-3">
                The revised version will always show the latest “Last Updated”
                date.
              </p>
            </PolicySection>
            ...
            <PolicySection title="8. SMS">
              ...
              <p className="mt-3">
                ...
                Note: If the customer has a Terms and Conditions page, this
                information should be included there, and not in the privacy
                policy. The document must include the following:
              </p>
              ...
              <div className="mt-4 space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-2">
                    ...
                    Professional TC Services, you may receive messages related
                    to the following (provide specific examples):
                  </p>
                  ...
                  <p className="mt-3">
                    Example: "Hello, this is a friendly reminder of your
                    upcoming appointment with Dr. [Name] at [Location] on [Date]
                    at [Time]. Reply STOP to opt out of SMS messaging at any
                    time."
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2">
                    ...
                    messages per week related to your [appointments/billing,
                    etc.].
                  </p>
                  <p className="mt-3">Example:</p>
                  <p className="mt-2">
                    "Message frequency may vary. You may receive up to 2 SMS
                    messages per week regarding your appointments or account
                    status."
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2">
                    ...
                    depending on your carrier’s pricing plan. These fees may
                ...
                <div>
                  ...
                  <p className="mt-2">
                    You may opt-in to receive SMS messages from (Professional TC
                ...
                <div>
                  ...
                  <p className="mt-2">
                    If you do not wish to receive SMS messages, you can choose
                    not to check the SMS consent box on our forms.
                  </p>
                </div>
